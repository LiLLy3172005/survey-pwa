...
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxPsn12AYIZwCrQUugmk0NEg9_Win-RR_5gK9g8-hMAIlmnN_QG3DjrCKY8old1mr1ktA/exec";

const DB_NAME = "survey-db";
const DB_VERSION = 1;
...
form.addEventListener("submit", async (event) => {
  ...
  const now = new Date();
  const session = {
    sessionId: "s_" + now.getTime() + "_" + Math.random().toString(36).slice(2, 8),
    ...
    answers: [
      "Năm học: " + document.getElementById("q1").value,
      "Đi làm thêm: " + document.getElementById("q2").value,
      "Công việc mong muốn: " + document.getElementById("q3").value,
      "Lương mong muốn: " + document.getElementById("q4").value,
      "Khó khăn: " + document.getElementById("q5").value,
    ],
